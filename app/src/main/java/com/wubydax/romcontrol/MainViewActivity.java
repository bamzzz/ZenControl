...
public class MainViewActivity extends AppCompatActivity
        ...
        * See more detailed instructions on the thread or in annotations to the previous method*/
        ...
        switch (position) {
			...
			case 2:
				...
				break;
			case 3:
				getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new TweakFragment()).commitAllowingStateLoss();
				break;
			case 4:
    ...
    * we will add PowerManager for items: Reboot, Reboot recovery and Reboot Download*/
    ...
    private void getRebootAction(final String command) {
		...
		switch (command){
			case("reboot"):
				RebootConfirm = R.string.reboot;
				break;
			case("busybox killall system_server"):
				RebootConfirm = R.string.reboot_hot;
				break;
			case("reboot recovery"):
				RebootConfirm = R.string.reboot_reco;
				break;
			case("reboot bootloader"):
				RebootConfirm = R.string.reboot_bl;
				break;
			case("pkill com.android.systemui"):
				RebootConfirm = R.string.reboot_ui;
				break;
		}
		//Dialog
		AlertDialog.Builder confirm = new AlertDialog.Builder(MainViewActivity.this);
		confirm.setMessage(RebootConfirm);
