    ...
    public void setup(int fragmentId, DrawerLayout drawerLayout, Toolbar toolbar, Context c) {
        ...
        mActionBarDrawerToggle = new ActionBarDrawerToggle(getActivity(), mDrawerLayout, toolbar, R.string.drawer_open, R.string.drawer_close) {
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                if (!isAdded()) return;
				// Make drawer will open every time the activity is launched
				// http://forum.xda-developers.com/android/apps-games/app-rom-control-app-devs-t3146567/post62474932
