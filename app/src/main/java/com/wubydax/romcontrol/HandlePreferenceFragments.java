...
public class HandlePreferenceFragments implements SharedPreferences.OnSharedPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    * OnPreferenceClickListener is also initiated here, so our preferences are ready to go.*/
    ...
    public void allGroups(Preference p) {
		...
		// MOD Add Intent http://forum.xda-developers.com/android/apps-games/app-rom-control-app-devs-t3146567/post61754656
        ...
        for (Map.Entry<String, ?> entry : keys.entrySet()) {
            ...
            if (entry.getValue() instanceof Boolean) {
                ...
                * After that it will be just fine. No biggie for a great cause of not wiping my device anymore to try and catch the bastard*/
				...
				// Add ThumbnailListPreference
				// http://forum.xda-developers.com/android/apps-games/app-rom-control-app-devs-t3146567/post63548185
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        switch (p.getClass().getSimpleName()) {
            ...
            case "MyListPreference":
				...
				/*// MOD
				switch (key){
					case("dropdown_layout_style"):
						appRebootRequired("com.android.systemui");
						break;
					case("signal_icon_style"):
						appRebootRequired("com.android.systemui");
						break;
					case("data_icon_type_style"):
						appRebootRequired("com.android.systemui");
						break;
					case("battery_icon_style"):
						appRebootRequired("com.android.systemui");
						break;
					case("omni_header_style"):
						appRebootRequired("com.android.systemui");
						break;
				}
				// End*/
...
//    }
	...
	private void handleKeysToKillProcess(String key){
		String[] keysForContacts = {"dialer_background_colorxxx", "main_letter_colorxxx"};
		String[] keysForFramework = {"mbuhlah"};
		String[] keysForSystemUI = {"dropdown_layout_style", "signal_icon_style", "data_icon_type_style", "battery_icon_style", "sb_alarm_icon", "sb_bluetooth_icon", "sb_sound_icon", "pulldown_text", "omni_header_style"};
		String[][] allArrays = {keysForContacts, keysForFramework, keysForSystemUI}; //the order of objects matters! (0,1,2)
				...
				if(key.equals(allArrays[objPos][keyPos])){
					switch(objPos){
						case 0: //array keysForContacts
							...
							break;
						case 1: //array keysForFramework
							appRebootRequired("zygote");
							break;
						case 2: //array keysForSystemUI
							appRebootRequired("com.android.systemui");
							/**
							 * Or since you're using systemui kill here
							 * You can call a method appRebootRequired("com.android.systemui") for visible reboot*/
							break;
